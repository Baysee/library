function [datadouble_1,datadouble_2]=findDoubleCoincSelectedDat(pulseTrigDelay,dataCoinc,plotHist,plotNumEvents)
...
searchRange=pulseTrigDelay+5; %large search range; stop loop if numEvents goes to 0 after some time.
...
for i=1:searchRange
    ...
    [phot_ids_tD2_diffCh_Channels_sorted,phot_ids_tD2_Channels_diffCh_order]=... % Sort counts by channel
