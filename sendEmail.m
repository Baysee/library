% User input
source = 'uoplab175@gmail.com';              %from address (gmail)
destination = 'benjamin.crockett@inrs.ca';              %to address (any mail service)
myEmailPassword = 'pwduop123';                  %the password to the 'from' account
